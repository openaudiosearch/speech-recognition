...
#
# This script is a modification of local/chain2/run_tdnn.sh from mini_librispeech
...
# System                tdnn1a_sp
#WER oed_test (tgsmall)      17.50
#WER oed_test (tglarge)      12.67
...
if [ $stage -le 14 ]; then
  ...
  prefinal-layer name=prefinal-chain input=prefinal-l $prefinal_opts small-dim=256 big-dim=1024
  ...
  prefinal-layer name=prefinal-xent input=prefinal-l $prefinal_opts small-dim=256 big-dim=1024
